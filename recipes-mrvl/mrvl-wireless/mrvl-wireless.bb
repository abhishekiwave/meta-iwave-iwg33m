...
FILES_${PN}-firmware = "${base_libdir}/firmware/mrvl"

FILES_${PN}-modules = "${base_libdir}/modules/mrvl"
...
SRC_URI = "file://sduart8987_combo_jody-w2-sdiouart.bin \
          ...
          file://WlanCalData_ext_0.1_hw.conf \
...
do_install() {
    ...
    install -m 0777 ${WORKDIR}/WlanCalData_ext_0.1_hw.conf ${D}${base_libdir}/firmware/mrvl/
    install -m 0777 ${WORKDIR}/WlanCalData_ext.conf ${D}${base_libdir}/firmware/mrvl/
